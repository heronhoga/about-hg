...
function App() {
  return (
    <div>
        ...
        >
          <div id="about-me">
            ...
            <p className="text-justify md:text-xl">
              Hi everyone! my name is Hoga Cavan Afrinata and you can simply
              call me Hoga. I'm a computer engineering student at Universitas
              Diponegoro. I love to learn anything related to computer.
            </p>
            <hr className="my-3" />
            <p className="md:text-xl">Social media:</p>
            <div id="social-media-list">
              <a
                href="https://instagram.com/afrinataaa"
                target="_blank"
              ...
              <a
                href="https://id.linkedin.com/in/afrinata"
                target="_blank"
                className="inline-block"
              >
                <svg
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-800 text-white"></div>
    </div>
  );
}
